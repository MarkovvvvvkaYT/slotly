...
export function AdminDashboard({ initialBookings, initialServices, profile, demo }: Props) {
  ...
  return <div className="mx-auto max-w-6xl px-5 py-8 lg:px-8 lg:py-12">
    <div className="mb-8 flex flex-wrap items-end justify-between gap-5">
      <div><p className="eyebrow mb-3">Рабочий стол владельца</p><h1 className="display text-4xl font-bold sm:text-5xl">Управляйте записью спокойно</h1><p className="mt-2 text-[var(--muted)]">{demo ? "Демо-режим · изменения сохраняются до перезагрузки" : "Заявки, услуги и расписание в одном месте"}</p></div>
