...
export default async function ProfilePage() {
  ...
  return <main className="min-h-screen bg-[var(--paper)] px-5 py-10 lg:px-8"><div className="mx-auto max-w-6xl"><AdminPageHeader profileName={data.profile.name} profileUrl={data.demo ? "/" : `/p/${data.profile.slug}`} /><AdminNavigation current="/admin/profile"/><ProfileEditor profile={data.profile} demo={data.demo} /></div></main>;
}
